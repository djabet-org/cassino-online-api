...
# importing
from modules.crash_manager import probabilidade_padrao_minutos
...
class TestManager(unittest.TestCase):
    ...
    def test_probabilidade_padrao_minutos(self):
        result = probabilidade_padrao_minutos(self.velas)
        self.assertEqual(result[0], '100%')
        self.assertEqual(result[4], '0%')

    def test_probabilidade_padrao_minutos_g1(self):
        result = probabilidade_padrao_minutos(self.velas, 1)
        self.assertEqual(result[0], '100%')
